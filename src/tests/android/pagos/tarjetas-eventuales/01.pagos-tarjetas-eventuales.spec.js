...
describe('Generacion de Pagos', () => {
    it('Generacion de Pagos de Tarjetas Eventuales', async() => {
        const data = searchEntry(files.pagos, [dataConditions.typeIs(dataTypes.pagos),dataConditions.subtypeIs(dataSubtypes.TarjetasEventuales), dataConditions.statusIs(dataStatus.pending)]);
