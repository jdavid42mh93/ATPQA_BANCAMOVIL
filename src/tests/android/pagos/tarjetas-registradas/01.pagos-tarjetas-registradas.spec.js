...
describe('Generacion de Pagos', () => {
    it('Generacion de Pagos de Tarjetas Registradas', async() => {
        const data = searchEntry(files.data, [dataConditions.typeIs(dataTypes.pagos),dataConditions.subtypeIs(dataSubtypes.TarjetasRegistradas), dataConditions.statusIs(dataStatus.pending)]);
