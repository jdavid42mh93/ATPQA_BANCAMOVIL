...
// Test de seccion de Pagos y Pagos de Tarjetas Registradas
describe('Generacion de Pagos', () => {
    it('Generacion de Pagos de Tarjetas Registradas', async() => {
        const data = searchEntry(files.pagos, [dataConditions.typeIs(dataTypes.pagos),dataConditions.subtypeIs(dataSubtypes.TarjetasRegistradas), dataConditions.statusIs(dataStatus.pending)]);
